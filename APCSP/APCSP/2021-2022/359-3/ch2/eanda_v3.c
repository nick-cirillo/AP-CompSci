...
char * ChooseLetters(char * alpha1[], char * alpha2[], int i, int j);

int main(void)
{
    char * alpha1[] = {"B", "C", "D", "F", "G", "H", "J", "K", "L", "M", "N", "P", "Qu", "R", "S", "T", "V", "W", "X", "Y", "Z"};
    char * alpha2[] = {"B", "C", "D", "F", "G", "J", "K", "L", "M", "N", "P", "Qu", "R", "S", "T", "V", "W", "X", "Y", "Z"};
    int measures = 0;
    int choice = 0;
    int choicetemp = -1;
    srand(time(0));
    randChar1 = ChooseLetters(alpha1, alpha2, rand() % 21, 1);
    randChar2 = ChooseLetters(alpha1, alpha2, rand() % 20, 2);
